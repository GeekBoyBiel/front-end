...
!(function ($) {
    ...
    unmasked: function () {
      return this.map(function () {
        var a,
          ...
          c = -1 !== b.indexOf("-");
        return (
          $(b.split(/\D/).reverse()).each(function (b, c) {
        ...
        this.each(function () {
          function b() {
            var a,
              ...
              h = 0;
            return (
              "number" == typeof f.selectionStart &&
              "number" == typeof f.selectionEnd
                ? ((g = f.selectionStart), (h = f.selectionEnd))
                : ((b = document.selection.createRange()),
                  b &&
                    ...
                    (e = f.createTextRange()),
                    e.collapse(!1),
                    c.compareEndPoints("StartToEnd", e) > -1
                      ? (g = h = d)
                      : ((g = -c.moveStart("character", -d)),
                        (g += a.slice(0, g).split("\n").length - 1),
                        c.compareEndPoints("EndToEnd", e) > -1
                          ? (h = d)
                          : ((h = -c.moveEnd("character", -d)),
                            (h += a.slice(0, h).split("\n").length - 1))))),
              { start: g, end: h }
            );
          }
          function c() {
            var a = !(
              ...
              e = c.end,
              f =
                c.start !== c.end && s.val().substring(d, e).match(/\d/)
                  ? !0
                  : !1,
          ...
          function f(b) {
            ...
            return (
              ...
              (c = g + i),
              a.precision > 0 &&
                ((d = h.slice(h.length - a.precision)),
                  ...
                  ? (j(c),
                    ...
                    e === f &&
                      (8 === k
                        ? "" === a.suffix
                          ? (e -= 1)
                          : ((i = h.split("").reverse().join("").search(/\d/)),
                            (e = h.length - i - 1),
                            (f = e + 1))
                        : (f += 1)),
          ...
          function m() {
            ...
            var a,
              b = s.get(0);
            b.createTextRange &&
              ((a = b.createTextRange()), a.collapse(!1), a.select());
          }
          function n() {
            setTimeout(function () {
              h();
          ...
          function o() {
            ...
            return b
              .toFixed(a.precision)
              .replace(new RegExp("\\.", "g"), a.decimal);
          }
          function p(b) {
            if (($.browser.msie && k(b), "" === s.val() || s.val() === e(o())))
              a.allowZero
                ? a.affixesStay
                  ? s.val(e(o()))
                  : s.val(o())
          ...
          function q() {
            var a,
              b = s.get(0);
            b.setSelectionRange
              ? ((a = s.val().length), b.setSelectionRange(a, a))
              : s.val(s.val());
          }
          var r,
            s = $(this);
  ...
  $.fn.maskMoney = function (b) {
    return a[b]
      ? a[b].apply(this, Array.prototype.slice.call(arguments, 1))
      : "object" != typeof b && b
      ? ($.error("Method " + b + " does not exist on jQuery.maskMoney"), void 0)
